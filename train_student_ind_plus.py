...
from train_and_eval import distill_run_inductive_plus
import warnings
...
def run(args):
    ...
    """ Load data """
    g, (idx_train, idx_val, idx_test), generate_node_features, metapaths = load_data(args.dataset, return_mp=True)
    ...
    conf['metapaths'] = metapaths
    conf['min_ns'] = [1 if mp[0] != 'contains' else 2 for mp in metapaths]
    ...
    return distill_run_inductive_plus(conf, obs_g, g, splits, log=logger.info)
