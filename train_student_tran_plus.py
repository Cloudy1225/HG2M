...
from train_and_eval import distill_run_transductive_plus
import warnings
...
def run(args):
    ...
    """ Load data """
    g, splits, generate_node_features, metapaths = load_data(args.dataset, return_mp=True)
    ...
    return distill_run_transductive_plus(conf, g, splits, log=logger.info)
